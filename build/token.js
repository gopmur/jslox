...
exports.keywordsMap = exports.Token = exports.TokenType = void 0;
class Identifier {
}
var TokenType;
(function (TokenType) {
...
class Token {
    constructor(tokenType, lexeme, line, literal) {
    ...
    toString() {
        return `{type: ${TokenType[this.tokenType]}, lexeme: ${this.lexeme}, line: ${this.line}, literal ${this.literal}}`;
    }
}
exports.Token = Token;
exports.keywordsMap = {
